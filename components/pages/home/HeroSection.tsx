    ...
    <div className='items-center grid h-[90vh]'>
      <div className='flex flex-col gap-2 w-full sm:w-4/5 md:w-3/5 mt-8 sm:mt-0 self-auto sm:self-center'>
        ...
        <div className='flex items-center gap-2'>
          <Link
            className='bg-buttonBackground1 h-10 min-w-[2.5rem] font-sans transition-all items-center inline-flex appearance-none justify-center select-none relative whitespace-nowrap outline-none outline-offset-2 leading-[1.2] font-semibold text-buttonForeground1 rounded-2xl ps-4 pe-4 border-0 hover:border-2 hover:border-buttonHoverBorder1 hover:shadow-sm hover:bg-buttonHover1'
            href='/projects'
          >
            Projects
          </Link>
