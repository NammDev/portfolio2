...
const OtherProjects = () => {
  ...
  return (
    <>
      <Link
        href='/projects'
        className='mb-[22px] bg-cardBorder1 h-8 text-sm min-w-[2rem] font-sans transition-all items-center inline-flex appearance-none justify-center select-none relative whitespace-nowrap outline-none outline-offset-2 leading-[1.2] font-semibold text-buttonForeground1 rounded-2xl ps-3 pe-3 border-0 hover:border-2 hover:shadow-sm hover:bg-buttonBackground1'
